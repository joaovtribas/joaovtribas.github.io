...
Ao longo do tempo, pretendo publicar conteúdos como:



\- Projetos de Ciência de Dados e análise de dados;

\- Resumos e anotações dos assuntos que estiver estudando;
...
Sempre gostei de entender padrões e resolver problemas. O que mais me chamou atenção na Ciência de Dados foi justamente a possibilidade de transformar um monte de informações soltas em algo que faça sentido.



Seja analisando dados esportivos, estudando tendências de mercado ou simplesmente organizando uma base bagunçada, acho muito interessante quando os dados conseguem contar uma história.
...
Este site vai evoluir junto comigo. Conforme eu aprender novas ferramentas, linguagens e técnicas, vou atualizando o conteúdo e compartilhando os projetos que desenvolver.



Se você também gosta de tecnologia, programação, estatística ou Ciência de Dados, espero que encontre algo útil por aqui.
